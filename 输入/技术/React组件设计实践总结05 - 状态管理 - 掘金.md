...
- [01 类型检查](https://juejin.im/post/6844903842392309768)
- [02 组件的组织](https://juejin.im/post/6844903843189243917)
- [03 样式的管理](https://juejin.im/post/6844903843902275592)
- [04 组件的思维](https://juejin.im/post/6844903844711759880)
- [05 状态管理](https://juejin.im/post/6844903848255946766)

**文章目录**

- [状态管理](https://juejin.im/post/6844903848255946766#%E7%8A%B6%E6%80%81%E7%AE%A1%E7%90%86)
- [你不需要状态管理](https://juejin.im/post/6844903848255946766#%E4%BD%A0%E4%B8%8D%E9%9C%80%E8%A6%81%E7%8A%B6%E6%80%81%E7%AE%A1%E7%90%86)
- [你不需要复杂的状态管理](https://juejin.im/post/6844903848255946766#%E4%BD%A0%E4%B8%8D%E9%9C%80%E8%A6%81%E5%A4%8D%E6%9D%82%E7%9A%84%E7%8A%B6%E6%80%81%E7%AE%A1%E7%90%86)
- [Redux](https://juejin.im/post/6844903848255946766#redux)
- [Mobx](https://juejin.im/post/6844903848255946766#mobx)
- [RxJS](https://juejin.im/post/6844903848255946766#rxjs)
- [其他状态管理方案](https://juejin.im/post/6844903848255946766#%E5%85%B6%E4%BB%96%E7%8A%B6%E6%80%81%E7%AE%A1%E7%90%86%E6%96%B9%E6%A1%88)
- [扩展阅读](https://juejin.im/post/6844903848255946766#%E6%89%A9%E5%B1%95%E9%98%85%E8%AF%BB)
...
状态管理最基础的解决方式就是分层，也就是说和传统的 `MV*` 模式没有本质区别, 主流状态管理的主要结构基本都是这样的:
 [1](../_resources/330d216356410ebb69587307c11ee558.webp)
他们基本都包含这些特点:
...
例如: 简单的使用 Context API 来做状态管理:
 [1](../_resources/0a330c6f6355a5e8358836dae25256f0.webp)

最近 hooks 用得比较爽(参考上一篇文章: [组件的思维](https://juejin.im/post/6844903844711759880))，我就想配合 Context API 做一个状态管理器, 后来发现早就有人这么干了： [unstated-next](https://github.com/jamiebuilds/unstated-next), 代码只有 38 行(Hooks+Context)，接口非常简单:

 [1](../_resources/f39b5285744597f82f6babe84f4f8c39.webp)
依赖于 hooks 本身灵活的特性，我们可以用它来做很多东西, 仅限于想象力. 例如异步数据获取:
 [1](../_resources/e12f247a2fb07eab9a6bcfa7fd5a3085.webp)
抑或者实现 Redux 的核心功能:
[(L)](https://codesandbox.io/s/redux-hooks-w1plr?fontsize=14)

[![1](../_resources/d17799bfee1d200e164f13c85d1724c5.png)](https://codesandbox.io/s/redux-hooks-w1plr?fontsize=14)
...
本文不打算深入介绍 Redux 的相关实践， 社区上面有非常多的教程，官方文档也非常详尽. 这里会介绍 Redux 的主要架构和核心思想，以及它的适用场景.
 [1](../_resources/685bc8e5e8d89fddb8058c683750bb7f.webp)
...
- **单一数据源** -> 可预测，简化数据流：数据只能在一个地方被修改
 ...
 [1](../_resources/85819f90a1a54844d57c6310a4efc462.webp)
...
个人觉得[react-boilerplate](https://github.com/react-boilerplate/react-boilerplate/blob/master/docs/general/introduction.md)是最符合官方‘最佳实践’的项目模板. 它的应用工作流如下:
 ...
 [1](../_resources/8c6f8e2856c52ac30eba5e16d42cfef1.webp)
特性:
...
[1](../_resources/d0a243dfba515cad61911387a185a275.webp)

笔者个人更喜欢类似 Vuex 这种`Ducks`风格的组织方式，将模块下的 action，saga，reducer 和 mapper 都组织在一个文件下面:
 [1](../_resources/298eaaf72719be348dd0216d77705701.webp)
Redux 的二次封装框架基本采用类似的风格, 如[`rematch`](https://github.com/rematch/rematch)
 [1](../_resources/dba2f082dac8488e34c5d1f8544da0e4.webp)
...
前面文章也提到过‘分离逻辑和视图’和‘分离容器组件和展示组件’，这两个规则都来自于 Redux 的最佳实践。**Redux 就是一个'非分形的架构'，如下图，在这种简单的‘横向分层'下, 视图和逻辑(或状态)可以被单独复用，但在 Redux 中却很难将二者作为一个整体的组件来复用**:
 ...
 [1](../_resources/a558211ed427f43b9de9b02ed40f44f7.webp)  *集中化的 Store，再通过 Connect 机制可以让状态在整个应用范围内被复用；Dumb 组件抽离的状态和行为，也容易被复用*
...
现在假设你需要将单个 container 抽离成独立的应用，单个 container 是无法独立工作的。**在分形的架构下，一个‘应用’有更小的‘应用’组成，‘应用’内部有自己的状态机制，单个应用可以独立工作，也可以作为子应用**. 例如 Redux 的鼻祖 Elm 的架构:
 ...
 [1](../_resources/05dd897cf3b3a4040873cc9046f2acb2.webp)  *Store的结构和应用的结构保持一致, 每个 Elm 组件也是一个 Elm 应用，包含完整的Action、Update、Model和View. 使得单独的应用可以被复用*
...
- [Cycle.js 状态管理模型](https://juejin.im/post/6844903741187981326)
...
[1](../_resources/a926d4155090a972cf8ba5a933b1693e.webp)
...
[1](../_resources/27513575ae412882cb066c490971910e.webp)
...
示例
	...
	tsimport { observable, computed, reaction } from 'mobx';
...
根 Store
	...
	复制代码
	tsx<Provider rootStore={new RootStore()}>
	  <App />
	</Provider>
	复制代码
...
换句话说适不适合大型项目是项目组织问题, Mobx 前期并没有提出任何解决方案和最佳实践。这不后来其作者也开发了[mobx-state-tree](https://github.com/mobxjs/mobx-state-tree)这个神器，作为 MobX 官方提供的状态模型构建库，MST 吸收了 Redux 等工具的优点，**旨在结合不可变数据/函数式(transactionality, traceability and composition)和可变数据/面向对象(discoverability, co-location and encapsulation)两者的优点**， 提供了很多诸如数据镜像(time travel)、hot reload、action middleware、集成 redux-devtools 以及强类型(Typescript + 运行时检查(争议点))等很有用的特性, 其实它更像是后端 ActiveRecord 这类 ORM 工具, 构建一个对象图。
 ...
 [1](../_resources/c2961dcbd6bd0947d57ac366607cb22b.webp)
典型的代码：
 [1](../_resources/80e7354db243bfb7c3cf0e4b3b700102.webp)
