...
新建项目目录，接下来的所有代码都会在该目录中完成
	...
	shellmkdir micro-frontend && cd micro-frontend
	复制代码
...
### 新建子应用
	...
	shellvue create app1
	复制代码

> 按图选择，去除一切项目不需要的干扰项，后面一路回车，等待应用创建完毕

 ![5c60db4a69a849e6af2214a02d4935df~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/c1635a6eb1c4131559461b644b1abbd0.png)

 ![6a027b80d3d34b46934629bd9b51ab01~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/4b41f4f2a2c19e2ca975d851d72e4cdc.png)
...
在项目根目录下新建`vue.config.js`文件
	...
	javascriptconst package = require('./package.json')
	module.exports = {
...
![11c15258d5ca4a129b18ffadb87478a6~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/5d47f0a45b9361002d0a84a07351f7bb.png)
...
![3966235ac67648a183517357a62e5ff9~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/0397ff0454613d5a3e6245bbb043331d.png)
...
### 安装`react-router-dom`、`single-spa-react`
	...
	shellnpm i react-router-dom single-spa-react -S
	复制代码
...
![294f4c6828574294a8eebef06a3aa346~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/b3c7da4ecffd5d9b6ec16ec26b99b49a.png)

![b6d107db273141a1888248fd1379d423~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/8b9bdd2403386b429e17015e81ce0ec0.png)

![ad6856f3d8fa4376a7a7a9ce54747667~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/46995f134c674e0220e812ef40b493f7.png)
...
### 浏览器访问基座应用
 ...
 ![c861159484c64ea8bf71d254f3df28d6~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/b63e7ec958f0311069d919fad70d4c51.png)  ![ce7cf883fbb54eef84dfbc00299ff8a3~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/53695d2a0c6bda27c6bcce51ba175945.png)
...
![3a55c39884644a36bdf2cc31520ce91a~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/5cf39d430c70a143423c0e3273ae867c.png)

> 这是我在阅读时整理的一个思维导图，源码中也写了大量的注释，大家可以参照着进行阅读。Ok ！！这就开始吧

![5c1d7ffe15bc48e3bde1a10feccff6cd~tplv-k3u1fbpfcp-zoom-1.image](https://gitee.com/hjb2722404/tuchuang/raw/master/img/097fe07c5344b3e3ffd017844bd189e9.png)
...
> single-spa/src/applications/apps.js
	...
	javascript*// 保证第二个参数一定是一个返回 promise 的函数*
...
> single-spa/src/applications/apps.js
	...
	javascript*// 保证 props 不为 undefined*
...
> single-spa/src/applications/apps.js
	...
	javascript*// 得到一个函数，函数负责判断浏览器当前地址是否和用户给定的baseURL相匹配，匹配返回true，否则返回false*
...
> single-spa/src/applications/apps.js
	...
	javascriptexport function pathToActiveWhen(path) {
...
> single-spa/src/applications/app.helpers.js
	...
	javascript*// 返回boolean值，应用是否应该被激活*
...
> single-spa/src/lifecycles/unload.js
	...
	javascript*// 移除完成，执行一些清理动作，其实就是从appsToUnload数组中移除该app，移除生命周期函数，更改app.status*
...
> single-spa/src/lifecycles/bootstrap.js
	...
	javascript*// 初始化app，更改app.status，在合理的时间内执行bootstrap生命周期函数*
...
> single-spa/src/lifecycles/mount.js
	...
	javascript*// 挂载app，执行mount生命周期函数，并更改app.status*
...
> single-spa/src/navigation/navigation-events.js
	...
	javascriptfunction createPopStateEvent(state, originalMethodName) {
...
> single-spa/src/navigation/navigation-events.js
	...
	javascriptexport function setUrlRerouteOnly(val) {
	  urlRerouteOnly = val;
	}
...
写代码之前，必须理清框架内子应用的各个状态以及状态的变更过程，为了便于理解，代码写详细的注释，希望大家看完以后都可以实现一个自己的`single-spa`
	...
	javascript*// 实现子应用的注册、挂载、切换、卸载功能*
